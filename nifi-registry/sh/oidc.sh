...
prop_replace "nifi.registry.security.user.oidc.client.id" "${NIFI_REGISTRY_SECURITY_USER_OIDC_CLIENT_ID:-$(cat ${REGISTRY_SECURITY_USER_OIDC_CLIENT_ID_FILE})}"
prop_replace "nifi.registry.security.user.oidc.client.secret" "${NIFI_REGISTRY_SECURITY_USER_OIDC_CLIENT_SECRET:-$(cat ${REGISTRY_SECURITY_USER_OIDC_CLIENT_SECRET_FILE})}"
